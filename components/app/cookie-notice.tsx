  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 mx-auto max-w-xl rounded-lg border border-[var(--line)] bg-white p-4 shadow-lg">
      <p className="text-sm leading-6 text-[var(--foreground)]">
        Loyelio utilise uniquement les cookies necessaires au fonctionnement du compte. Les outils de paiement et d authentification peuvent deposer leurs propres cookies.
      </p>
